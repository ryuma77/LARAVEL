...
@section('content')
<h1 class="text-2xl font-semibold mb-6">Add Chart of Account</h1>

<form action="{{ route('coa.store') }}" method="POST" class="bg-white p-4 rounded shadow">
    @csrf

    <div class="mb-4">
        <label class="block text-sm font-medium">Code</label>
        <input type="text" name="code" class="border p-2 w-full rounded" required>
    </div>
